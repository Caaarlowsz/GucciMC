...
public class Kit implements CommandExecutor, Listener {
	...
	public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
		...
		if (label.equalsIgnoreCase("kit")) {
			if (args.length == 0) {
				p.sendMessage(String.valueOf(GucciPvP.p) + "�7 Use /Kit [habilidade]");
				return true;
			}
			...
			if (args[0].equalsIgnoreCase("pvp")) {
				if (p.hasPermission("kit.pvp")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l PvP");
				} else {
			...
			if (args[0].equalsIgnoreCase("Forcefield")) {
				if (p.hasPermission("kit.Forcefield")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Forcefield");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("C4")) {
				if (p.hasPermission("kit.C4")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l C4");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Avatar")) {
				if (p.hasPermission("kit.Avatar")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Avatar");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Terrorista")) {
				if (p.hasPermission("kit.Terrorista")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Terrorista");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("WaterBender")) {
				if (p.hasPermission("kit.WaterBender")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l WaterBender");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("DeshFire")) {
				if (p.hasPermission("kit.DeshFirer")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l DeshFire");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("BloodGun")) {
				if (p.hasPermission("kit.BloodGun")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l BloodGun");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Velotrol")) {
				if (p.hasPermission("kit.Velotrol")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Velotrol");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Grappler")) {
				if (p.hasPermission("kit.Grappler")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Grappler");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("QuickDropper")) {
				if (p.hasPermission("kit.QuickDropper")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l QuickDropper");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("FireBoost")) {
				if (p.hasPermission("kit.FireBoost")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l FireBoost");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Kangaroo")) {
				if (p.hasPermission("kit.Kangaroo")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Kangaroo");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Batman")) {
				if (p.hasPermission("kit.Batman")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Batman");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Anchor")) {
				if (p.hasPermission("kit.Anchor")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Anchor");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Stomper")) {
				if (p.hasPermission("kit.Stomper")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Stomper");
				} else {
					p.sendMessage(GucciPvP.semperm);
				}
			}
			if (args[0].equalsIgnoreCase("Smoke")) {
				if (p.hasPermission("kit.Smoke")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Smoke");
			...
			if (args[0].equalsIgnoreCase("Foguinho")) {
				if (p.hasPermission("kit.Foguinho")) {
					...
					p.sendMessage(String.valueOf(GucciPvP.p) + "�7Voce pegou o Kit�a�l Foguinho");
