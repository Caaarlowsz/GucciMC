...
public class Tag implements Listener, CommandExecutor {
	...
	public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
		...
		if (args.length != 0) {
			if (args[0].equalsIgnoreCase("normal")) {
				if (p.hasPermission("tag.normal")) {
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �7�lNORMAL �7!");
			...
			if (args[0].equalsIgnoreCase("pro")) {
				if (p.hasPermission("tag.pro")) {
					p.sendMessage(String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �6�lPRO �7!");
			...
			if (args[0].equalsIgnoreCase("builder")) {
				if (p.hasPermission("tag.builder")) {
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �9�lBUILDER �7!");
			...
			if (args[0].equalsIgnoreCase("mvp")) {
				if (p.hasPermission("tag.mvp")) {
					p.sendMessage(String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �9�lMVP �7!");
			...
			if (args[0].equalsIgnoreCase("yt")) {
				if (p.hasPermission("tag.yt")) {
					p.sendMessage(String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �b�lYT �7!");
			...
			if (args[0].equalsIgnoreCase("trial")) {
				if (p.hasPermission("tag.trial")) {
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �d�lTRIAL �7!");
			...
			if (args[0].equalsIgnoreCase("tk")) {
				if (p.hasPermission("tag.tk")) {
					p.sendMessage(String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �e�lTK �7!");
			...
			if (args[0].equalsIgnoreCase("copa")) {
				if (p.hasPermission("tag.copa")) {
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �e�lCOPA �7!");
			...
			if (args[0].equalsIgnoreCase("mod")) {
				if (p.hasPermission("tag.mod")) {
					p.sendMessage(String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �5�lMOD �7!");
			...
			if (args[0].equalsIgnoreCase("mod+")) {
				if (p.hasPermission("tag.mod+")) {
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �5�lMOD+ �7!");
					p.setDisplayName("�5�lMOD+ �5" + p.getName());
					p.setPlayerListName("�5" + getShortStr(p.getName()));
					NametagAPI.setPrefix(p.getName(), "�5�lMOD+ �5");
					return true;
			...
			if (args[0].equalsIgnoreCase("admin")) {
				if (p.hasPermission("tag.admin")) {
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �c�lADMIN �7!");
			...
			if (args[0].equalsIgnoreCase("ajudante")) {
				if (p.hasPermission("tag.ajudante")) {
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �e�lAJUDANTE �7!");
			...
			if (args[0].equalsIgnoreCase("vip")) {
				if (p.hasPermission("tag.vip")) {
					p.sendMessage(String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �a�lVIP �7!");
			...
			if (args[0].equalsIgnoreCase("spro")) {
				if (p.hasPermission("tag.spro")) {
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �6�lSPRO �7!");
			...
			if (args[0].equalsIgnoreCase("fundador")) {
				if (p.hasPermission("tag.fundador")) {
					...
					p.sendMessage(
							String.valueOf(String.valueOf(GucciPvP.p)) + " �7Sua tag foi alterada para: �3�lFUNDADOR �7!");
		...
		if (p.hasPermission("tag.normal")) {
			p.sendMessage(" ");
			p.sendMessage(String.valueOf(String.valueOf(GucciPvP.p)) + " �7Suas tags:");
			p.sendMessage(" ");
