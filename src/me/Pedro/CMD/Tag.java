        ...
        if (args.length != 0) {
            if (args[0].equalsIgnoreCase("normal")) {
                if (p.hasPermission("tag.normal")) {
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §7§lNORMAL §7!");
            ...
            if (args[0].equalsIgnoreCase("builder")) {
                if (p.hasPermission("tag.builder")) {
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §9§lBUILDER §7!");
            ...
            if (args[0].equalsIgnoreCase("trial")) {
                if (p.hasPermission("tag.trial")) {
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §d§lTRIAL §7!");
            ...
            if (args[0].equalsIgnoreCase("copa")) {
                if (p.hasPermission("tag.copa")) {
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §e§lCOPA §7!");
            ...
            if (args[0].equalsIgnoreCase("admin")) {
                if (p.hasPermission("tag.admin")) {
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §c§lADMIN §7!");
            ...
            if (args[0].equalsIgnoreCase("ajudante")) {
                if (p.hasPermission("tag.ajudante")) {
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §e§lAJUDANTE §7!");
            ...
            if (args[0].equalsIgnoreCase("spro")) {
                if (p.hasPermission("tag.spro")) {
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §6§lSPRO §7!");
            ...
            if (args[0].equalsIgnoreCase("dona")) {
                if (p.hasPermission("tag.dona")) {
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §4§lDONA SUA LINDA §7!");
            ...
            if (args[0].equalsIgnoreCase("fundador")) {
                if (p.hasPermission("tag.fundador")) {
                    if (!p.getName().equals("reacteey") && p.getName() != "reacteey") {
                        ...
                        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.plugin, (Runnable)new Tag.Tag$1(this, p), 60L);
                    }
                    p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Sua tag foi alterada para: §3§lFUNDADOR §7!");
