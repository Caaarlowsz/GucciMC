            ...
            if (p.hasPermission("kitpvp.build")) {
                if (args.length == 0) {
                    ...
                    if (!Build.embuild.contains(t)) {
                        Build.embuild.add(t);
                        p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Voc\u00ea §aativou §7o modo build para o jogador: §b" + t.getName() + " §7!");
                    }
                    else {
                        Build.embuild.remove(t);
                        p.sendMessage(String.valueOf(String.valueOf(Main.p)) + " §7Voc\u00ea §cdesativou §7o modo build para o jogador: §b" + t.getName());
                    }
                }
            }
            else {
