...
public final class ReflectionHandler {
	...
	public static Constructor<?> getConstructor(final String className, final PackageType type,
			final Class<?>[] parameterTypes) throws Exception {
		return getConstructor(getClass(className, type), parameterTypes);
	}

	public static Constructor<?> getConstructor(final String className, final SubPackageType type,
			final Class<?>[] parameterTypes) throws Exception {
		return getConstructor(getClass(className, type), parameterTypes);
	}
	...
	public static Object newInstance(final String className, final PackageType type, final Object[] args)
			throws Exception {
		return newInstance(getClass(className, type), args);
	}

	public static Object newInstance(final String className, final SubPackageType type, final Object[] args)
			throws Exception {
		return newInstance(getClass(className, type), args);
	}
	...
	public static Method getMethod(final String className, final PackageType type, final String name,
			final Class<?>[] parameterTypes) throws Exception {
		return getMethod(getClass(className, type), name, parameterTypes);
	}

	public static Method getMethod(final String className, final SubPackageType type, final String name,
			final Class<?>[] parameterTypes) throws Exception {
		return getMethod(getClass(className, type), name, parameterTypes);
	}
	...
	public static Object invokeMethod(final Class<?> clazz, final String name, final Object instance,
			final Object[] args) throws Exception {
		return getMethod(clazz, name, DataType.convertToPrimitive(args)).invoke(instance, args);
	}

	public static Object invokeMethod(final String className, final PackageType type, final String name,
			final Object instance, final Object[] args) throws Exception {
		return invokeMethod(getClass(className, type), name, instance, args);
	}

	public static Object invokeMethod(final String className, final SubPackageType type, final String name,
			final Object instance, final Object[] args) throws Exception {
		return invokeMethod(getClass(className, type), name, instance, args);
	}
	...
	public static Field getField(final String className, final SubPackageType type, final String name)
			throws Exception {
		return getField(getClass(className, type), name);
	}
	...
	public static Field getDeclaredField(final String className, final PackageType type, final String name)
			throws Exception {
		return getDeclaredField(getClass(className, type), name);
	}

	public static Field getDeclaredField(final String className, final SubPackageType type, final String name)
			throws Exception {
		return getDeclaredField(getClass(className, type), name);
	}
	...
	public static Object getValue(final Class<?> clazz, final Object instance, final String fieldName)
			throws Exception {
		return getField(clazz, fieldName).get(instance);
	}

	public static Object getValue(final String className, final PackageType type, final Object instance,
			final String fieldName) throws Exception {
		return getValue(getClass(className, type), instance, fieldName);
	}

	public static Object getValue(final String className, final SubPackageType type, final Object instance,
			final String fieldName) throws Exception {
		return getValue(getClass(className, type), instance, fieldName);
	}
	...
	public static Object getDeclaredValue(final Class<?> clazz, final Object instance, final String fieldName)
			throws Exception {
		return getDeclaredField(clazz, fieldName).get(instance);
	}

	public static Object getDeclaredValue(final String className, final PackageType type, final Object instance,
			final String fieldName) throws Exception {
		return getDeclaredValue(getClass(className, type), instance, fieldName);
	}

	public static Object getDeclaredValue(final String className, final SubPackageType type, final Object instance,
			final String fieldName) throws Exception {
		return getDeclaredValue(getClass(className, type), instance, fieldName);
	}
	...
	public static void setValue(final Class<?> clazz, final Object instance, final String fieldName,
	...
	public static void setValue(final String className, final PackageType type, final Object instance,
	...
	public static void setValue(final String className, final SubPackageType type, final Object instance,
			final String fieldName, final Object fieldValue) throws Exception {
		setValue(getClass(className, type), instance, fieldName, fieldValue);
	}
	...
	public static void setValues(final Class<?> clazz, final Object instance, final FieldPair[] pairs)
			throws Exception {
		for (final FieldPair pair : pairs) {
	...
	public static void setValues(final String className, final PackageType type, final Object instance,
			final FieldPair[] pairs) throws Exception {
		setValues(getClass(className, type), instance, pairs);
	}

	public static void setValues(final String className, final SubPackageType type, final Object instance,
			final FieldPair[] pairs) throws Exception {
		setValues(getClass(className, type), instance, pairs);
	}

	public static void setDeclaredValue(final Object instance, final String fieldName, final Object fieldValue)
			throws Exception {
	...
	public static void setDeclaredValue(final Class<?> clazz, final Object instance, final String fieldName,
			final Object fieldValue) throws Exception {
		final Field f = getDeclaredField(clazz, fieldName);
		f.set(instance, fieldValue);
	}

	public static void setDeclaredValue(final Class<?> clazz, final Object instance, final FieldPair pair)
			throws Exception {
		setDeclaredValue(clazz, instance, pair.getName(), pair.getValue());
	}

	public static void setDeclaredValue(final String className, final PackageType type, final Object instance,
			final String fieldName, final Object fieldValue) throws Exception {
	...
	public static void setDeclaredValue(final String className, final SubPackageType type, final Object instance,
			final String fieldName, final Object fieldValue) throws Exception {
		setDeclaredValue(getClass(className, type), instance, fieldName, fieldValue);
	}
	...
	public static void setDeclaredValues(final Class<?> clazz, final Object instance, final FieldPair[] pairs)
			throws Exception {
		for (final FieldPair pair : pairs) {
	...
	public static void setDeclaredValues(final String className, final PackageType type, final Object instance,
			final FieldPair[] pairs) throws Exception {
		setDeclaredValues(getClass(className, type), instance, pairs);
	}

	public static void setDeclaredValues(final String className, final SubPackageType type, final Object instance,
			final FieldPair[] pairs) throws Exception {
		setDeclaredValues(getClass(className, type), instance, pairs);
	}

	public enum DataType {
		BYTE((Class<?>) Byte.TYPE, (Class<?>) Byte.class), SHORT((Class<?>) Short.TYPE, (Class<?>) Short.class),
		INTEGER((Class<?>) Integer.TYPE, (Class<?>) Integer.class), LONG((Class<?>) Long.TYPE, (Class<?>) Long.class),
		CHARACTER((Class<?>) Character.TYPE, (Class<?>) Character.class),
		FLOAT((Class<?>) Float.TYPE, (Class<?>) Float.class), DOUBLE((Class<?>) Double.TYPE, (Class<?>) Double.class),
	...
	public enum PackageType {
		MINECRAFT_SERVER("MINECRAFT_SERVER", 0,
				"net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().substring(23)),
	...
	public enum PacketType {
		...
		PLAY_OUT_SCOREBOARD_DISPLAY_OBJECTIVE("PLAY_OUT_SCOREBOARD_DISPLAY_OBJECTIVE", 73,
		...
		PLAY_OUT_SPAWN_ENTITY_EXPERIENCE_ORB("PLAY_OUT_SPAWN_ENTITY_EXPERIENCE_ORB", 79,
	...
	public enum SubPackageType {
		BLOCK("BLOCK", 0), CHUNKIO("CHUNKIO", 1), COMMAND("COMMAND", 2), CONVERSATIONS("CONVERSATIONS", 3),
		ENCHANTMENS("ENCHANTMENS", 4), ENTITY("ENTITY", 5), EVENT("EVENT", 6), GENERATOR("GENERATOR", 7),
		HELP("HELP", 8), INVENTORY("INVENTORY", 9), MAP("MAP", 10), METADATA("METADATA", 11), POTION("POTION", 12),
		PROJECTILES("PROJECTILES", 13), SCHEDULER("SCHEDULER", 14), SCOREBOARD("SCOREBOARD", 15),
		UPDATER("UPDATER", 16), UTIL("UTIL", 17);
