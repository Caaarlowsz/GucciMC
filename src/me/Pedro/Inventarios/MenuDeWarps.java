...
public class MenuDeWarps implements Listener
{
    ...
    public static void Treino(final Player p) {
        ...
        SetarItem(inv, p, Material.BEDROCK, 1, 0, "§b§lVoidChallenger", "§c- §7Clique para ir a warp void challenge!", 11);
        SetarItem(inv, p, Material.LAVA_BUCKET, 1, 0, "§b§lLavaChallenger", "§c- §7Clique para ir a warp lavachallenger !", 15);
    ...
    public static void AbrirWarps(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && p.getItemInHand().getType() == Material.COMPASS && Habilidade.getAbility(p).equalsIgnoreCase("Nenhum")) {
            Warps(p);
