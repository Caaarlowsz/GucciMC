...
public class Kits implements Listener, CommandExecutor
{
    ...
    public static void guiKits1(final Player p) {
        ...
        metapyro3.setLore((List)descpyro3);
        ...
        metapyro4.setLore((List)descpyro4);
        ...
        if (p.hasPermission("kit.pvp")) {
            ...
            metapyro5.setLore((List)descpyro5);
        ...
        for (int descpyro6 = (arrayOfItemStack = inv.getContents()).length, metapyro6 = 0; metapyro6 < descpyro6; ++metapyro6) {
            final ItemStack itemStack = arrayOfItemStack[metapyro6];
        }
        p.openInventory(inv);
    }
    ...
    public void onPlayerCLickInventry(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equalsIgnoreCase("§b§lKITS") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
